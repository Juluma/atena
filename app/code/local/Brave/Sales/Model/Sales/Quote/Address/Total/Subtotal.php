...
class Brave_Sales_Model_Sales_Quote_Address_Total_Subtotal extends Mage_Sales_Model_Quote_Address_Total_Abstract
{
    /**
    ...
    public function collect(Mage_Sales_Model_Quote_Address $address)
    {
        ...
        /**
         * Get quantities of products with same ID for tiered prices
         */
        $tieredQtys = array();
        foreach ($items as $item) {
            $id = $item->getProduct()->getId();
            $tieredQtys[$id] = (isset($tieredQtys[$id])) ? $tieredQtys[$id] + $item->getQty() : $item->getQty();
        }
        ...
        foreach ($items as $item) {
             ...
             */
            $id = $item->getProduct()->getId();
            if (array_key_exists($id, $tieredQtys)) {
                $item->setTieredQty($tieredQtys[$id]);
            }
