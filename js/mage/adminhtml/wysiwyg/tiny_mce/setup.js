...
tinyMceWysiwygSetup.prototype =
{
    ...
    getSettings: function(mode)
    {
        ...
        var settings = {
            ...
            plugins : plugins,
            style_formats:[
                {title : 'Oranssi nappi', block : 'button', classes : 'button btn-atena', exact: true},
                {title : 'Kampanja mobiilikuva', block : 'div', classes : 'kampanja-kuva', exact: true},
                {title : 'Mobiilissa musta varjo', block : 'div', classes : 'mobiili-varjo', exact: true},
                {title : 'Mobiilissa valkea varjo', block : 'div', classes : 'mobiili-valkea-varjo', exact: true},
                {title : 'Mobiilissa musta teksti', block : 'div', classes : 'mobiili-musta-txt', exact: true},
                {title : 'Mobiilissa valkea teksti', block : 'div', classes : 'mobiili-valkea-txt', exact: true}
            ],
